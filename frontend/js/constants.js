...
const welcome_p = 'The DogzTown NFT Project is a decentralized, open-source test project that aims to demonstrate the development and launch of an NFT Collection.';
